...
class PredictPipeline:
    ...
    def predict(self, features):
        try:
            ...
            data_scaled_df_boruta = data_scaled_df[boruta_columns]
            
            data_scaled_df_boruta_np = np.array(data_scaled_df_boruta)
            preds = model.predict(data_scaled_df_boruta_np)
